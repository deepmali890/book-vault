...
export default function Home() {
  ...
  if (windowWidth === undefined) {
    return <div className="h-screen flex justify-center items-center">
      <div className="bg-transparent dark:bg-gray-800 flex justify-center items-center w-screen h-screen p-5">
        <div className="border border-gray-200 p-2 text-[40px] rounded-md shadow-lg  shadow-gray-800">
          <div className="flex items-end gap-1">
            <span className="text-6xl font-semibold dark:text-white">B</span>
            <svg
            ...
            <span className="text-6xl font-semibold dark:text-white">K</span>
            <span className="text-6xl font-semibold text-gray-800">Vault</span>
          </div>
        </div>
      </div>;
