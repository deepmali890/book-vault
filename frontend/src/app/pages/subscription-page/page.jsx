                ...
                >
                    <section className="py-24 relative">
                        ...
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="mb-12">
                                <h2 className="font-manrope text-5xl text-center font-bold text-gray-800 mb-4">Suitable pricing plans</h2>
                            ...
                            <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                                ...
                                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                                    <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                                        <div className="w-16 h-16 rounded-full bg-gray-80 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-gray-800">
                                            <svg className="w-6 h-6 text-gray-800 transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-gray-800">Free Plan</h3>
                                    ...
                                    <a href="javascript:;" className="py-2.5 px-5 bg-gray-80 shadow-sm rounded-full transition-all duration-500 text-base text-gray-800 font-semibold text-center w-fit mx-auto group-hover:bg-gray-800 group-hover:text-white ">Purchase Plan</a>
                                ...
                                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                                    <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                                        <div className="w-16 h-16 rounded-full bg-gray-80 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-gray-800">
                                            ...
                                            <svg className="w-6 h-6 text-gray-800 transition-all duration-300 group-hover:text-white" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-gray-800">Business Plan</h3>
                                        <div className="flex items-center justify-center">
                                ...
                                <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                                    <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                                        ...
                                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-gray-800">Enterprise Plan</h3>
                                        <div className="flex items-center justify-center">
