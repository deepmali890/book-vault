      ...
      <AuroraBackground>
        ...
        >
          <div>
            ...
            <h3 className='text-5xl my-10 text-center font-medium'><Cover className="mx-auto flex gap-4">Complete Your Purchase <MdOutlineShoppingCartCheckout /></Cover></h3>
            <div className="font-sans max-w-6xl max-lg:max-w-2xl mx-auto bg-white p-4">
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <form>
                  ...
                  <div className="grid gap-4 mt-8">
                    <div>
                      ...
                      <input type="text" placeholder="John Doe"
                        className="px-4 py-3 bg-transparent text-gray-800 w-full text-sm border border-gray-300 rounded-md focus:border-gray-500 outline-none" />
                    </div>

                    <div>
                      <label className="block text-base font-semibold text-gray-800 mb-2">Card Number</label>
                      <div className="flex bg-transparent border border-gray-300 rounded-md focus-within:border-gray-500 overflow-hidden">
                  ...
                  <button type="button" className="mt-8 text-sm px-4 py-3 w-full font-semibold tracking-wide bg-gray-800 hover:bg-gray-800 text-white rounded-md">Make Payment  </button>
                </form>
              </div>
            </div>
          </div>
